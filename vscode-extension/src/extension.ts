...
<html lang="en">
  <head>
    ...
    <meta http-equiv="Content-Security-Policy" content="default-src 'none'; img-src ${this.panel.webview.cspSource} data: https:; style-src ${this.panel.webview.cspSource}; script-src 'nonce-${nonce}';">
